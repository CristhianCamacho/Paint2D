...
public class Ventana_de_espera_PaintJ extends Window implements Runnable{

    Color color_de_fondo=new Color(128,185,150);
    Color color_de_texto=new Color(31,63,127);
    Color color_de_borde=Color.BLUE;
    ...
    static int TAM_CUAD = 150;//tamaño de la figura
    int[] tam ={ 150 , 150 };//5
    ...
    public Ventana_de_espera_PaintJ(Dimension dimension,Dimension dim_espera)
    {
        super(new Frame());
        textos = true;
        figuras = true;
        ...
        tamaños_fuentes=new int[n];
        pos_X_fuentes=new int[n];
        pos_Y_fuentes=new int[n];
        for(int i=0;i<n;i++)
        {
            todas_las_fuentes[i]=temp[i];
            tamaños_fuentes[i]=(int)( Math.random()*(int)( Math.pow( DIM_X*DIM_Y , 0.5 )/15) );
        ...
        bufferedImage = new BufferedImage( (int)(TAM_CUAD), (int)(TAM_CUAD) , BufferedImage.TYPE_3BYTE_BGR);//tamaño de los cubos
        diseño_de_cubo(bufferedImage,TAM_CUAD,TAM_CUAD);
    ...
    public void cargar_valores_iniciales()
    {
        if(DIM_X > DIM_Y)
        {
            ...
            font_titlulo = new Font("Adler", Font.TYPE1_FONT , (int)(DIM_Y/9));
    ...
    public void diseño_de_cubo(BufferedImage b,int ancho,int alto)
    {
        ...
        graphics2d.fillRect( 1, 1, ancho-1, alto-1 );//tamaño de los cuadrados en el relleno
...
///////////////////////////////////////////////////////////////////////////////
    ...
    public void dibujar_texto(Graphics2D graphics2d,int p)
    {
        ...
        graphics2d.drawString(s, 40 , pos_y_Producto+10 );

        graphics2d.setColor(Color.white);
        graphics2d.setFont(font_nombre);
        graphics2d.drawString("Corba Newbies", 30 , pos_y_Autor );
...
///////////////////////////////////////////////////////////////////////////////
    ...
    public void sonar()
    {
        /************************************************
         AudioStream as;
         try {
         as = new AudioStream(new FileInputStream("Graficador_3D/sound/sound_harp.au"));
